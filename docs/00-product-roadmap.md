...
현재 후속 작업: [Change 008](../tasks/osan-project-001-change-008.md)의 2026-09-14 단계 안내 사진·납기 HOLD·모바일 자동 단계 진입·완료 배경/긴 제목·QR 해독 보정은 로컬 구현 및 관련 검증을 마치고 사용자 검수 대기다. 실제 아이폰 QR 검수, 최종 후보 전체 회귀, 명시 승인 후 병합·공개배포가 남는다.
