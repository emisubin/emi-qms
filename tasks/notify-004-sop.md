...
- [x] Pending 재발송이 다음 시도 시각만 앞당김을 이해
- [x] Failed가 terminal 상태임을 이해
- [x] Failed는 acknowledge/dismiss만 지원함을 확인
- [x] DB 직접 변경과 반복 재발송 금지를 확인
- [x] At-least-once와 duplicate 가능 경계를 이해
- [x] 후속 기능 요청 시 필요한 fixed-field 정보를 확인

사용자는 2026-07-14 이 체크리스트를 검수 완료하고 PR #44의 squash merge를 승인했다.
