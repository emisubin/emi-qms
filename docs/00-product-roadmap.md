...
| 6.2 | TASK-AZURE-DEPLOY-001 — 20일 Azure 시범 배포 | BUGFIX / UAT_RUNTIME | Change 025 Main Merged / Azure Released | PR #103 필수 CI 뒤 exact main SHA `58c089993587deea30513cb6edee0b8396a1d474`의 release `31786040822`를 실행했다. migration `0078`, Backend·Frontend, public security가 모두 통과했고 Web Push 활성·Key Vault 참조를 보존했다. | TASK-AZURE-PILOT-001, Change 018 승인형 workflow, TASK-CI-COST-001, TASK-ADMIN-003 Change 002, TASK-PWA-PUSH-001 Change 002 | 기존 운영 인증·Teams·메일·업무 데이터와 VAPID 원문 보존. 미완성 공통 매뉴얼 작업 제외 | Yes | 운영 관찰; `GHA-AZURE-RUNNER-WARNINGS-001` P3 유지보수 |
