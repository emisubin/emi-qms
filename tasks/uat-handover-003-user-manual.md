...
- [ ] Processing filter와 attempt 이력 이해 가능
- [ ] 승인된 사용자 발송 1건의 fail-stop과 단일 Sent lineage 이해
- [ ] Review-safe 접속 정상
- [ ] Ledger 28/29/1 이해
- [ ] 승인된 delivery 1건 외 provider 호출 0 확인
- [ ] Backup과 Persistent UAT 보존 확인
- [ ] At-least-once 제한 이해
- [ ] SOP 이해 가능
- [ ] 다음 TASK-NOTIFY-ESC-001 확인
