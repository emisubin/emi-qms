...
- [ ] purge 기본 true 이해
- [ ] false 시 DI 미등록과 query 0 확인
- [ ] ReviewSafe에서 세 worker 미등록 확인
- [ ] Phase A projection false 확인
- [ ] due synthetic 후보 불변 확인
- [ ] Persistent UAT와 기존 runtime 무변경 확인
- [ ] backup 보존/fresh backup 정책 이해
- [ ] HANDOVER-003 재개 순서 이해
- [ ] 신규 기능 No-Go 확인
