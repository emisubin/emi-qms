...
- 상태/다음 순서: 구현·자동 검증 완료 후보 / 사용자 검수 대기 / Draft PR / 다음 controlled UAT 적용은 별도 승인
...
- 사용자 검수: Checklist 작성됨 / 자동 검증 완료 / 사용자 검수 대기 / 미체크 항목 유지
...
| 60 | Escalation starvation | 구현·자동 검증 완료 후보 / 사용자 검수 대기 | 개발/운영 | TASK-NOTIFY-ESC-001 | 기존 evaluation timestamp fair ordering, 후보 오류 격리, 101/200/201 유한 poll, 중복 0. Persistent UAT worker는 disabled 유지 |
