...
후속 모바일 탐색·앱 내 QR 스캔·작은 7단계 스텝퍼·W/O 패널 연결은 [Change 008](../tasks/osan-project-001-change-008.md)의 2026-09-12 기록을 따른다. 로컬 구현·직접 검증 완료, 다음은 사용자 검수와 실제 아이폰 카메라 확인이다. 이번 수정의 원격 병합·공개배포는 아직 실행하지 않았다.
