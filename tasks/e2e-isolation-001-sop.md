...
- [ ] 기본 명령으로 E2E를 시작할 수 있음
- [ ] UAT와 다른 E2E container/network가 보임
- [ ] E2E storage가 tmpfs이고 Docker volume을 사용하지 않음
- [ ] UAT 이름을 지정하면 SQL 전에 거부됨
- [ ] E2E 종료 후 E2E-only 자원이 남지 않음
- [ ] E2E 전후 UAT health와 data가 유지됨
- [ ] 실제 외부 알림이 발생하지 않음
