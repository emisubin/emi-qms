...
- [x] desktop·390px adaptive 화면, 모바일 horizontal overflow 0, 좌상단 menu와 다양한 shape
...
- [ ] [좌상단 메뉴 Mobile 390](010a-screenshots/04-panel-kitting-menu-mobile-390.jpg): bottom navigation 없음과 `키팅` active 상태 확인
