...
| 6.2 | TASK-AZURE-DEPLOY-001 — 20일 Azure 시범 배포 | BUGFIX / UAT_RUNTIME | Change 030 Exact-main Azure Released / Automated Public Formula Check Complete / User Validation Pending | G2 Change 004 제품 PR #119를 exact main `7a2c7f172a4a0e4b0e69a29c72ac205af1299c74`로 병합하고 Azure release `33589472932`로 Backend·Frontend를 배포했다. Migration은 변경 없음으로 생략했고 public security, health `200`, 익명 root·API `401/401`을 통과했다. 인증된 공개 G2에서 2026-08-28의 `2 + 34 - 0 - 30 = 6`과 표시 재고 `6`이 일치한다. 기존 운영 인증·외부 알림·Key Vault 참조·업무/G2 원본 데이터를 보존했다. | TASK-AZURE-PILOT-001, TASK-CI-COST-001, TASK-SITE-ACCESS-001, TASK-G2-OPERATIONS-002 Change 004 | 사용자 G2·사이트 접속 운영 화면 검수, 기존 운영 인증·알림 설정·업무 데이터 보존 | Yes | 사용자 운영 화면 검수 → 운영 관찰 |
