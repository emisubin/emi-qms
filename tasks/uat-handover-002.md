...
| User validation checklist | 이 문서 22절 및 각 운영 문서 | Checklist 작성됨 / 자동 검증 완료 / 사용자 검수 대기 |
...
- [ ] Migration 호환 상태 표시
- [ ] Canonical 27 / Live 28 / Legacy 1 표시
- [ ] 프로젝트·업무·알림·관리자 조회 정상
- [ ] 검색·필터·정렬·상세 이동 정상
- [ ] mutation action disabled
- [ ] Mutation API 423
- [ ] DB read-only
- [ ] Worker/provider 미실행
- [ ] Current 5190과 Candidate 5191 기능·구조 일치
- [ ] Console 오류 없음
- [ ] 390px/Teams narrow pane overflow 없음
- [ ] 실제 사용자·프로젝트·알림 원문이 검증 보고에 노출되지 않음
- [ ] Development 5174/5081 유지
- [ ] Preview 5185 유지
- [ ] Persistent UAT 데이터 유지
- [ ] Legacy marker 미삭제
- [ ] SOP 실행 가능
- [ ] User manual 이해 가능
- [ ] UAT-VERIFY-001이 다음에 처음부터 재실행됨을 이해
