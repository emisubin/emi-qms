...
try {
    ...
    Start-Process powershell -ArgumentList "-NoExit", "-Command", "`$env:ASPNETCORE_ENVIRONMENT='Development'; cd '$root\backend'; dotnet run --project src\Emi.Qms.Api --urls http://localhost:5080"
