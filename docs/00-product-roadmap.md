...
| 3 | [TASK-OSAN-PROJECT-001](../tasks/osan-project-001.md) — 프로젝트 등록 | IMPLEMENTED_AWAITING_USER_VALIDATION | 1, 2 | Change 004 실제 공용 컴포넌트·paired 화면 확인 → 마지막 일괄 사용자 검수 |
...
| 99 | 오산 시범 운영 기획과 7단계 개발 로드맵 | Business Planning Approved / Task 1 USER_VALIDATION_COMPLETE / Task 2 IMPLEMENTED_AWAITING_BATCHED_USER_VALIDATION / Task 3 IMPLEMENTED_AWAITING_USER_VALIDATION | 사용자/개발/운영 | [TASK-OSAN-PILOT-001](../tasks/osan-pilot-001.md) | Task 1 DB 분리 기반과 사용자 검수 완료. Task 2는 자동 검증·독립 검증과 local commit 완료, Task 3은 등록·대상·7단계 snapshot 및 Change 004 실제 공용 컴포넌트·paired 시각 검증 GO 완료다. Change 004 현재 화면 검수, 마지막 일괄 사용자 검수와 후속 Task 4~6이 남았으며 다음 제품 Gate는 Task 4 구현 승인이다. Push·PR·merge·운영 적용은 별도 승인이다. |
