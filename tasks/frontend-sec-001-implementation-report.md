...
사용자는 화면 회귀, SOP/User manual 이해도와 audit High 0을 확인해야 한다. 현재 5174는 patch 전이므로 사용자 검수 완료 전에 merge하거나 patched UAT로 표현하지 않는다.
...
- User validation checklist: [Task 정의 18장](frontend-sec-001.md#18-사용자-검수-체크리스트), Checklist 작성됨 / 자동 검증 완료 / 사용자 검수 대기
