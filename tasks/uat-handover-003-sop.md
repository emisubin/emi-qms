...
- [ ] Review-safe 5190/5092 정상
- [ ] Processing/attempt UI 이해 가능
- [ ] 승인된 사용자 활동의 fail-stop·재분류·단일 Sent lineage 확인
- [ ] Ledger 28/29/1 확인
- [ ] Pending/Processing/provider call 0 확인
- [ ] Backup과 candidate 보존 확인
- [ ] At-least-once 제한 이해
- [ ] 다음 TASK-NOTIFY-ESC-001 순서 확인
