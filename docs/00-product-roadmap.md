...
2026-09-25 후속 사용성 보정은 로컬 구현·직접 검증·독립 검토를 마쳤으며 5258에서 사용자 검수 대기다. Excel형 필터, 모바일 메뉴, 승인 요청 사유, 고객사 담당 수/필터, 공지 편집·행 높이, 파스텔 강조(HOLD 제외)를 포함한다. 상세 범위·증거·잔여는 [OSAN-UX Change001 제20-21절](../tasks/osan-ux-001-change-001.md#20-21-공개배포-후-사용성-보정-2026-09-25-로컬-구현검증-완료)을 따른다. 이번 후속 보정의 원격 병합·공개배포는 미실행이다.
