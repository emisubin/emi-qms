...
현재 추가 요청은 [TASK-OSAN-PROJECT-001 Change 006](../tasks/osan-project-001-change-006.md)의 오산 프로젝트 엑셀 양식·미리보기·일괄 등록이다. 공개배포된 main `f5b6f71`에서 이어서 구현한다. 아래 큐는 앞선 오산 개발 순서를 보존하며, 이번 기능의 구현·검증·승인 상태는 Change 006이 소유한다.
