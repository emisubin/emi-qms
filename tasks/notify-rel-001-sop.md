...
`FailedPermanent`, Failed 상태, next attempt null을 확인한다. 대상/권한/설정 오류를 수정한 뒤 승인된 관리자 retry 절차를 사용한다. Processing은 retry 대상이 아니다.
...
- [ ] Processing count/filter와 disabled action
- [ ] attempt 번호/outcome/history
- [ ] stale lease 안내
- [ ] normal concurrency provider 1회
- [ ] late completion fencing
- [ ] at-least-once 제한
- [ ] Persistent UAT 0028 미적용
- [ ] actual provider call 0
- [ ] desktop/390px 오류·overflow 0
- [ ] TASK-UAT-HANDOVER-003 선행 확인
- [ ] 신규 기능 No-Go 확인
