...
- [TASK-INTERIOR-BUSBAR-001](../tasks/interior-busbar-001.md): 2026-09-09 사용자 명시 승인으로 청주 인테리어 부스바 신설 구현. 기존 오산 순서는 유지하며 전용 worktree에서 진행한다. 이카운트 발주 조회 연동은 해당 Task의 마지막 구현 단계다.
