...
public static class G2MetricCodes
{
    ...
    public static readonly IReadOnlyList<string> All = [MorningProduction, AfternoonProduction, Delivery, MorningEmiAttendance, MorningContractorAttendance, AfternoonEmiAttendance, AfternoonContractorAttendance];
}
...
public static class G2TargetTypes
{
    ...
    public static bool IsValid(string value) => value is DailyProduction or Inventory;
}
...
public sealed record SaveG2OperationsRequest(G2MetricChangeRequest? MorningProduction, G2MetricChangeRequest? AfternoonProduction, G2MetricChangeRequest? Delivery);
