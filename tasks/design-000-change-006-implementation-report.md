...
- 상태: `USER_VALIDATION_COMPLETE / LOCAL_MAIN_MERGE_APPROVED / REMOTE_UNPUBLISHED`
...
- Git 게시: local commit·local `main` merge 승인. 원격 push·PR·배포는 미승인
...
상태: `자동 검증 완료 / 사용자 검수 완료 / local main merge 승인 / 원격 미게시`.
...
사용자는 2026-08-01 업무 선택 전용 page 삭제, 클릭형 왼쪽 메뉴와 Graphite 디자인의 검수를 완료하고 local `main` 병합을 승인했다. 원격 push·PR·배포와 Azure 실행은 별도 경계로 남아 있다.
