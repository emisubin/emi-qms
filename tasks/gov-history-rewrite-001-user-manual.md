...
Cached pull-request reference 제거는 완료됐다. Repository는 별도 public 재개 결정 전까지 private이며, 기존 권한이 없는 사용자는 계속 접근할 수 없다.
...
- 별도 public 재개 승인 전 repository를 public으로 바꾸지 않는다.
...
- Repository가 승인 없이 public으로 바뀐 경우
