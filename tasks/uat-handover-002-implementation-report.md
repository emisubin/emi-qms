...
사용자는 새 5190의 주요 화면, 27/28/1, mutation 차단, 5191과의 구조 동등성, 개인정보 안전 보고, SOP와 User manual을 직접 확인해야 한다. UAT-VERIFY-001은 본 검수와 merge 뒤 별도 Task에서 처음부터 실행한다.
...
| User validation checklist | `tasks/uat-handover-002.md` 22절 | Checklist 작성됨 / 자동 검증 완료 / 사용자 검수 대기 |
