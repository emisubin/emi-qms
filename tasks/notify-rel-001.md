...
- [ ] Candidate 환경 접속 정상
- [ ] 알림 발송 상태에 발송 처리 중 표시
- [ ] Pending과 Processing이 구분됨
- [ ] Processing count/filter 정상
- [ ] Processing row action disabled
- [ ] Attempt 이력과 번호/outcome 이해 가능
- [ ] Stale lease 안내 이해 가능
- [ ] Pending/Sent/Failed 기존 표시 회귀 없음
- [ ] 정상 worker 경쟁 provider call 1회 증빙 확인
- [ ] 늦은 worker overwrite 0 증빙 확인
- [ ] exactly-once가 아님을 이해
- [ ] Persistent UAT에 0028 미적용 확인
- [ ] 실제 외부 발송 0 확인
