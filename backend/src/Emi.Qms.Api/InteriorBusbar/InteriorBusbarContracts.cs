...
public sealed record BusbarMasterRequest(Guid? Id, string Code, string Name, string? Unit = null, string? SupplyType = null, bool IsActive = true);
public sealed record BusbarSettingsRequest(string CommonProjectCode);
