...
| `DESIGN-000` | reference 기반 CSS semantic token·공통 React primitive, Change 001 black & white wireframe, Change 002 전 부서 입력 흐름 통일, Change 003 다중 업무의 `업무 선택→KPI·프로젝트→단일 프로젝트 입력` 분리·제조/품질 세로 패널 탐색·Pending KPI/프로젝트 목록과 상세 격리 | [본체](../tasks/design-000-implementation-report.md), [Change 001](../tasks/design-000-change-001-implementation-report.md), [Change 002](../tasks/design-000-change-002-implementation-report.md), [Change 003](../tasks/design-000-change-003-implementation-report.md) | `EXPERIMENT_COMPLETE / USER_VALIDATION_PENDING` |
