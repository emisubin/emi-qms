...
| 6.2 | TASK-AZURE-DEPLOY-001 — 20일 Azure 시범 배포 | BUGFIX / UAT_RUNTIME | Change 030 Exact-main Azure Released / Change 003 Local Implemented · User Validation Pending | 현재 공개 기준선은 G2 Change 004 제품 PR #119, exact main `7a2c7f172a4a0e4b0e69a29c72ac205af1299c74`, Azure release `33589472932`다. Change 031의 PR #121 head `11c1185e...`는 전체 검증을 통과했지만 아직 병합·배포하지 않았다. 사용자는 별도 사업부 소속 관리를 사용자 관리에 통합하는 TASK-OSAN-ACCESS-001 Change 003을 먼저 구현·검수하도록 순서를 바꿨다. Change 003은 Directory 0003 local-first publish, 회수 우선 차단과 일반 사용자 1개 사업부 강제를 구현해 최소 집중 검증을 통과했으며 local commit 사용자 검수 대기다. | TASK-AZURE-PILOT-001, TASK-CI-COST-001, TASK-SITE-ACCESS-001, TASK-G2-OPERATIONS-002 Change 004, TASK-OSAN-ISOLATION-001, TASK-OSAN-ACCESS-001, TASK-OSAN-PROJECT-001 | Change 002 selector+Change 003 통합 사용자 승인 검수, 최종 head 전체 회귀/CI 1회, exact main merge, 3-DB PITR rehearsal, actual account·Cheongju·Osan 검증 | Yes | Change 003 local 검수 → 승인된 PR #121 갱신 → 최종 head 전체 CI/회귀 1회 → exact main merge 승인 → DB/restore/app 순차 배포 |
