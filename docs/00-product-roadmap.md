...
| 6.5 | TASK-G2-OPERATIONS-002 — 납품 목표·불량·홈 임시 시뮬레이션 | NEW_FEATURE / BUGFIX / UAT_RUNTIME | Change 003 Main Merged / Azure Released / Public Read-only Check Complete | 사용자 승인 Codex 직접 기획·구현. Additive migration `0084`로 납품 목표와 불량을 정식 데이터에 추가하고 홈 저장 없는 임시 시뮬레이션을 제공한다. Change 003은 2026-08-28부터 `오늘 재고 = 전일 재고 + 전일 생산 - 전일 납품 - 전일 불량`으로 바꿔 해당 날짜에 출하 가능한 시작 재고를 표시한다. PR #117·exact main `58daf6d8bfe333cb00e343a3fcc13ee4f3358183`을 Azure release `33577473523`로 배포했고 공개 G2 8월 28일 재고 `6대`를 확인했다. | TASK-G2-OPERATIONS-001 완료 계약, 최초 PR #115, Change 003 PR #117 | Persistent UAT 미적용. 운영 G2 원본 데이터·schema 무변경 | Yes | 사용자 운영 관찰 |
...
| 97 | G2 납품 목표·불량·홈 임시 시뮬레이션 | Change 003 Main Merged / Azure Released / Public Check Complete | 사용자/제조/영업/물류/개발 | TASK-G2-OPERATIONS-002 | 최초 exact main `220d1201c9dbb881fb3e5c5061871fb943c7961b`에 납품 목표·불량·홈 임시 예상값과 migration `0084`가 반영됐다. Change 003은 PR #117·exact main `58daf6d8bfe333cb00e343a3fcc13ee4f3358183`, Azure release `33577473523`으로 배포됐고 공개 2026-08-28 재고 `6대`를 확인했다. Schema·원본 데이터·Persistent UAT는 변경하지 않았다. |
