...
public sealed record BusbarProjectRequest(Guid? Id, string Name, string CustomerJobNumber, Guid ProductFamilyId, int RequestedQuantity, string Destination, DateOnly DueDate, string? Reason = null, decimal? UnitPrice = null);
