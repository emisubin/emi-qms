...
| 0.4B | TASK-DESIGN-LOGIN-001 — Entra 로그인 공통 디자인 shell | BUGFIX | Change 010 Main Merged | Change 010 User Approved | Change 001~009 완료. Change 010 지정 로그인 로고와 iPhone·Android 흑백 wireframe 구현·전체 Frontend·PR CI 통과, PR #83 squash merge 완료 | 없음. Code Connect는 향후 필수 Gate에서 제외 | No | TASK-TEAMS-PWA-001 Change 007 내부 logo → 승인된 공개배포 |
...
| 3.3C | TASK-TEAMS-PWA-001 — Teams 실행 화면·PWA 설치·브랜드 통일 | BUGFIX | Change 007 Implementation / Validation In Progress | Change 001~003 구현·운영 rollout 완료. Change 007은 로그인 후 모든 page 공통 desktop/mobile shell에 지정 4x 내부 logo를 적용하고 지정 4x 로그인 logo를 보존 | Azure Easy Auth·Teams Activity 10종·기존 웹 MSAL·PWA icon·TASK-DESIGN-LOGIN-001 Change 010 | 사용자 제공 logo의 실제 PC·Android·iPhone 운영 화면 검수. Web Push는 별도 NEW_FEATURE | Yes | Change 007 자동·CI 검증 → main merge → 승인된 Azure 공개 release → 사용자 실제 기기 검수 |
...
- 상태/다음 순서: Change 001~003 운영 rollout 완료 / Change 007 로그인 후 공통 logo 구현·자동 검증 진행 중 / main 병합·Azure 공개 release·사용자 실제 기기 검수 대기
...
- 산출물: [Identity Gate](../tasks/teams-pwa-001-identity-gate.md), [Interview](../tasks/teams-pwa-001-interview.md), [Planning](../tasks/teams-pwa-001-planning.md), [Codex review](../tasks/teams-pwa-001-review.md), [Change 001](../tasks/teams-pwa-001-change-001.md), [Change 007](../tasks/teams-pwa-001-change-007.md), [Implementation report](../tasks/teams-pwa-001-implementation-report.md), [User validation checklist](../tasks/teams-pwa-001-user-validation-checklist.md), 이 Roadmap update
- 다음 Gate: Change 007 자동·CI 검증과 main 병합 뒤 최신 main을 Azure에 공개 release한다. 이후 desktop·Android·iPhone 실제 화면의 logo 구분과 기존 Teams launcher·Activity deep link를 검수한다. Web Push는 수신 정책을 다시 확정하는 별도 `NEW_FEATURE`다.
