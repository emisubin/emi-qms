...
- [x] Development 5174가 정상적으로 열림
- [x] 관리자 사용자 화면의 기존 목록·역할 표시가 정상임
- [x] Review-safe 5190이 조회 전용으로 유지됨
- [x] 마지막 administrator 변경 요청이 거부될 수 있음을 이해함
- [x] 거부 요청은 partial update 없이 rollback됨을 확인함
- [x] Persistent live user/role/deletion mutation이 수행되지 않았음을 확인함
- [x] Direct SQL·자동 backup restore 금지를 확인함
- [x] PR Ready·merge 여부를 별도로 승인함
